...
using lsccommon.configLang.queryDomain.Exceptions;
using lsccommon.configLang.queryPersistence.Repositories;
using Microsoft.EntityFrameworkCore.Storage;
using System.Collections;
using System.Data;

namespace lsccommon.configLang.queryPersistence
{
    /// <summary>
            ...
            if (!repositories.ContainsKey(type))
            {
                try
                {
                    ...
                    var repositoryInstance =
                        Activator.CreateInstance(repositoryType.MakeGenericType(typeof(TEntity), typeof(TKey)), dbContext);
